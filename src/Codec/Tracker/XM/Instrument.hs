...
data Instrument = Instrument
  { instrumentSize :: Word32
  , instrumentName :: [Word8]
  -- ^ 22 bytes
...
data ExtendedInstrumentHeader = ExtendedInstrumentHeader
  { sampleHeaderSize :: Word32
  , keymap :: [Word8]
...
getExtendedInstrumentHeader =
  ExtendedInstrumentHeader
    <$> getWord32le
    <*> replicateM 96 getWord8
    <*> replicateM 48 getWord8
    <*> replicateM 48 getWord8
    <*> getWord8
    <*> getWord8
    <*> getWord8
...
putInstrument Instrument {..} = do
  ...
  replicateM_ (fromIntegral instrumentSize - 29 - (if isJust extendedHeader then 214 else 0)) (putWord8 0)
